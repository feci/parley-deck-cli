...
# Owner decision: Windows scope and release order (supersedes the release wait rule in your brief)

Your brief said to wait for `codex-1-to-user_meta-protocol-change-lean-organizer_done.md`. That file now
exists, but CLI 1.49.1 is still being released. Wait instead for
`/Volumes/My Shared Files/AI_WORKSPACE/parley-deck/worktrees/lean-organizer/parley-deck/inbox/codex-1-to-user_release-1.49.1_done.md`.
